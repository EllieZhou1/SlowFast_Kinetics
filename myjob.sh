...
#SBATCH -o /n/fs/visualai-scr/temp_LLP/ellie/slowfast_kinetics/outfile        # send stdout to outfile
#SBATCH -e /n/fs/visualai-scr/temp_LLP/ellie/slowfast_kinetics/errfile  # send stderr to errfile
