...
#SBATCH -o /n/fs/visualai-scr/temp_LLP/ellie/slowfast_kinetics/outfile_minikinetics        # send stdout to outfile
#SBATCH -e /n/fs/visualai-scr/temp_LLP/ellie/slowfast_kinetics/errfile_minikinetics  # send stderr to errfile
