...
#SBATCH -o /n/fs/visualai-scr/temp_LLP/ellie/slowfast_kinetics/outfile_64        # send stdout to outfile
#SBATCH -e /n/fs/visualai-scr/temp_LLP/ellie/slowfast_kinetics/errfile_64  # send stderr to errfile
